...
struct TimeLord::Panel
{
   enum ParamId
   {
      ...
      RGB_Channel8_Display,
      Value_Channel7_Display,
      RGB_Channel7_Display,
      Value_Channel6_Display,
      RGB_Channel6_Display,
      Value_Channel5_Display,
      RGB_Channel5_Display,
      Value_Channel4_Display,
      RGB_Channel4_Display,
      Value_Channel3_Display,
      RGB_Channel3_Display,
      Value_Channel2_Display,
      RGB_Channel2_Display,
      Value_Channel1_Display,
      RGB_Channel1_Display,
      PARAMS_LEN
   };
