...
void TimeLordWidget::setup()
{
   ...
   makeButton(this, Vec(48.69, 214.62), TimeLord::Panel::BankUp);
   makeButton(this, Vec(61.34, 165.83), TimeLord::Panel::Mode);

   makeInput(this, Vec(159.64, 345.83),  TimeLord::Panel::Upload);
   makeInput(this, Vec(116.30, 345.83),  TimeLord::Panel::Pass);
   makeInput(this, Vec(65.64, 274.57),  TimeLord::Panel::Reset);
   makeInput(this, Vec(31.44, 274.22),  TimeLord::Panel::Clock);
   makeInput(this, Vec(116.67, 295.51),  TimeLord::Panel::Channel8_Pass);
   makeInput(this, Vec(117.07, 259.59),  TimeLord::Panel::Channel7_Pass);
   makeInput(this, Vec(117.07, 223.66),  TimeLord::Panel::Channel6_Pass);
   makeInput(this, Vec(117.07, 187.74),  TimeLord::Panel::Channel5_Pass);
   makeInput(this, Vec(117.07, 151.81),  TimeLord::Panel::Channel4_Pass);
   makeInput(this, Vec(117.07, 115.88),  TimeLord::Panel::Channel3_Pass);
   makeInput(this, Vec(117.07, 79.96),  TimeLord::Panel::Channel2_Pass);
   makeInput(this, Vec(117.07, 44.03),  TimeLord::Panel::Channel1_Pass);
   ...
   makeLCD(this, Vec(60.15, 202.62), 1, TimeLord::Panel::Text_Bank, TimeLord::Panel::RGB_Bank);
   makeLCD(this, Vec(133.08, 283.51), 3, TimeLord::Panel::Text_Channel8_Value, TimeLord::Panel::RGB_Channel8_Value);
   makeLCD(this, Vec(133.48, 247.59), 3, TimeLord::Panel::Text_Channel7_Value, TimeLord::Panel::RGB_Channel7_Value);
   makeLCD(this, Vec(133.48, 211.66), 3, TimeLord::Panel::Text_Channel6_Value, TimeLord::Panel::RGB_Channel6_Value);
   makeLCD(this, Vec(133.48, 175.74), 3, TimeLord::Panel::Text_Channel5_Value, TimeLord::Panel::RGB_Channel5_Value);
   makeLCD(this, Vec(133.48, 139.81), 3, TimeLord::Panel::Text_Channel4_Value, TimeLord::Panel::RGB_Channel4_Value);
   makeLCD(this, Vec(133.48, 103.88), 3, TimeLord::Panel::Text_Channel3_Value, TimeLord::Panel::RGB_Channel3_Value);
   makeLCD(this, Vec(133.48, 67.96), 3, TimeLord::Panel::Text_Channel2_Value, TimeLord::Panel::RGB_Channel2_Value);
   makeLCD(this, Vec(133.48, 32.03), 3, TimeLord::Panel::Text_Channel1_Value, TimeLord::Panel::RGB_Channel1_Value);

   makeOLED(this, Vec(10.00, 29.86), TimeLord::Panel::Pixels_Display, 80, 120);
