...
void GrooveMaestroWidget::setup()
{
   ...
   makeButton(this, Vec(27.32, 171.41), GrooveMaestro::Panel::DeviceIdDown);
   makeButton(this, Vec(27.32, 152.76), GrooveMaestro::Panel::DeviceIdUp);
   ...
   makeLCD(this, Vec(10.32, 117.58), 2, GrooveMaestro::Panel::Text_DeviceId, 18);
