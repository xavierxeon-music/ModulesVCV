#ifndef SchweineSystemMeterH
#define SchweineSystemMeterH
...
{
   rack::Widget* meterWidget = new SchweineSystem::Meter::Widget(pos, widget->getModule(), digitCount, paramId);
   widget->addChild(meterWidget);
}

#endif // NOT SchweineSystemMeterH
