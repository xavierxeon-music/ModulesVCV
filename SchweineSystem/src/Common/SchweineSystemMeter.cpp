...
SchweineSystem::Meter::Controller::Controller(rack::engine::Module* module, const uint16_t& valueParamId)
   : module(module)
...
void SchweineSystem::Meter::Controller::setMaxValue(const uint16_t& newMaxValue)
{
   valueMapper.setMaxInput(newMaxValue);
}

void SchweineSystem::Meter::Controller::setValue(const uint32_t& value)
{
...
SchweineSystem::Meter::Controller::List::List(rack::engine::Module* module)
   : module(module)
{
}

SchweineSystem::Meter::Controller::List::~List()
{
   for (Controller* instance : instanceList)
      delete instance;
}

void SchweineSystem::Meter::Controller::List::append(const std::vector<uint16_t>& paramIdList)
{
...
SchweineSystem::Meter::Controller* SchweineSystem::Meter::Controller::List::operator[](const uint16_t& index)
{
...
SchweineSystem::Meter::Widget::Widget(rack::math::Vec pos, rack::engine::Module* module, const uint8_t& segmentCount, const uint16_t& valueParamId)
...
void SchweineSystem::Meter::Widget::drawLayer(const DrawArgs& args, int layer)
{
   if (layer != 1)
      return;
