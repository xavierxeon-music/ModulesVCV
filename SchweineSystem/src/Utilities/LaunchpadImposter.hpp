...
void LaunchpadImposter::setup()
{
   ...
   configButton(Panel::RowOne_ColEight, "RowOne_ColEight");
   ...
   configButton(Panel::RowTwo_ColEight, "RowTwo_ColEight");
   ...
   configButton(Panel::RowThree_ColEight, "RowThree_ColEight");
   ...
   configButton(Panel::RowFour_ColEight, "RowFour_ColEight");
   ...
   configButton(Panel::RowFive_ColEight, "RowFive_ColEight");
   ...
   configButton(Panel::RowSix_ColEight, "RowSix_ColEight");
   ...
   configButton(Panel::RowSeven_ColEight, "RowSeven_ColEight");
   ...
   configButton(Panel::RowEight_ColEight, "RowEight_ColEight");
   ...
   configButton(Panel::RowNine_ColEight, "RowNine_ColEight");
...
void LaunchpadImposterWidget::setup()
{
   ...
   makeLEDButton(this, Vec(175.90, 323.26), LaunchpadImposter::Panel::RowOne_ColEight, LaunchpadImposter::Panel::RGB_RowOne_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 301.26), LaunchpadImposter::Panel::RowTwo_ColEight, LaunchpadImposter::Panel::RGB_RowTwo_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 279.26), LaunchpadImposter::Panel::RowThree_ColEight, LaunchpadImposter::Panel::RGB_RowThree_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 257.26), LaunchpadImposter::Panel::RowFour_ColEight, LaunchpadImposter::Panel::RGB_RowFour_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 234.26), LaunchpadImposter::Panel::RowFive_ColEight, LaunchpadImposter::Panel::RGB_RowFive_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 212.26), LaunchpadImposter::Panel::RowSix_ColEight, LaunchpadImposter::Panel::RGB_RowSix_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 189.26), LaunchpadImposter::Panel::RowSeven_ColEight, LaunchpadImposter::Panel::RGB_RowSeven_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 167.26), LaunchpadImposter::Panel::RowEight_ColEight, LaunchpadImposter::Panel::RGB_RowEight_ColEight);
   ...
   makeLEDButton(this, Vec(175.90, 137.94), LaunchpadImposter::Panel::RowNine_ColEight, LaunchpadImposter::Panel::RGB_RowNine_ColEight);
