#ifndef SyDisplayOLEDH
#define SyDisplayOLEDH
...
inline void makeOLED(Sy::ModuleWidget* widget, rack::math::Vec pos, const uint16_t& pixelId, const uint8_t& width, const uint8_t& height)
{
   rack::Widget* displayWidget = new Sy::DisplayOLED::Widget(pos, widget->getSchweineModule(), pixelId, width, height);
   widget->addChild(displayWidget);
}

#ifndef SyDisplayOLEDHPP
#include "SyDisplayOLED.hpp"
#endif // NOT SyDisplayOLEDHPP

#endif // NOT SyDisplayOLEDH
