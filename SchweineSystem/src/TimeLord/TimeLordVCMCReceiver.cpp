   ...
   , cvOutputList(this)
{
   ...
   {
      lightListGate[index]->setDefaultColor(Svin::Color{255, 0, 255});
...
void TimeLordVCMCReceiver::process(const ProcessArgs& args)
{
...
void TimeLordVCMCReceiver::processMessage(const midi::Message& msg)
{
...
void TimeLordVCMCReceiver::connectToMidiDevice()
{
   midiInput.reset();
...
void TimeLordVCMCReceiver::load(const Svin::Json::Object& rootObject)
{
   Svin::Json::Array gateArray = rootObject.get("gates").toArray();
   Svin::Json::Array cvArray = rootObject.get("cvs").toArray();
   Svin::Json::Array sliderArray = rootObject.get("sliders").toArray();
...
void TimeLordVCMCReceiver::save(Svin::Json::Object& rootObject)
{
   Svin::Json::Array gateArray;
   Svin::Json::Array cvArray;
   Svin::Json::Array sliderArray;
   for (uint8_t index = 0; index < 8; index++)
   {
...
TimeLordVCMCReceiverWidget::TimeLordVCMCReceiverWidget(TimeLordVCMCReceiver* module)
