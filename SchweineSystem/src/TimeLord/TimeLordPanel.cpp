...
void TimeLordWidget::setup()
{
   ...
   makeOutput(this, Vec(204.37, 213.03), TimeLord::Panel::Channel6_Output, false);
   makeOutput(this, Vec(204.37, 175.03), TimeLord::Panel::Channel5_Output, false);
   makeOutput(this, Vec(204.37, 137.03), TimeLord::Panel::Channel4_Output, false);
   makeOutput(this, Vec(204.37, 99.03), TimeLord::Panel::Channel3_Output, false);
   makeOutput(this, Vec(204.37, 61.03), TimeLord::Panel::Channel2_Output, false);
   makeOutput(this, Vec(204.37, 23.03), TimeLord::Panel::Channel1_Output, false);
   ...
   makeLCD(this, Vec(138.00, 98.63), 1, TimeLord::Panel::Text_Bank, 18);
   makeLCD(this, Vec(50.48, 277.03), 3, TimeLord::Panel::Text_Channel8_Value, 18);
   makeLCD(this, Vec(50.48, 239.03), 3, TimeLord::Panel::Text_Channel7_Value, 18);
   makeLCD(this, Vec(50.48, 201.03), 3, TimeLord::Panel::Text_Channel6_Value, 18);
   makeLCD(this, Vec(50.48, 163.03), 3, TimeLord::Panel::Text_Channel5_Value, 18);
   makeLCD(this, Vec(50.48, 125.03), 3, TimeLord::Panel::Text_Channel4_Value, 18);
   makeLCD(this, Vec(50.48, 87.03), 3, TimeLord::Panel::Text_Channel3_Value, 18);
   makeLCD(this, Vec(50.48, 49.03), 3, TimeLord::Panel::Text_Channel2_Value, 18);
   makeLCD(this, Vec(50.48, 11.03), 3, TimeLord::Panel::Text_Channel1_Value, 18);
