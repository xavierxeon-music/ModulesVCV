...
void TimeLordFlameCC::process(const ProcessArgs& args)
{
...
void TimeLordFlameCC::connectToMidiDevice()
{
   if (connected())
   {
...
void TimeLordFlameCC::sendSysEx()
{
...
void TimeLordFlameCC::load(const Svin::Json::Object& rootObject)
{
   Svin::Json::Array fullVoltageArray = rootObject.get("fullVoltage").toArray();
   for (uint8_t index = 0; index < 16; index++)
   {
...
void TimeLordFlameCC::save(Svin::Json::Object& rootObject)
{
   Svin::Json::Array fullVoltageArray;
   for (uint8_t index = 0; index < 16; index++)
   {
...
TimeLordFlameCCWidget::TimeLordFlameCCWidget(TimeLordFlameCC* module)
